<x-main>
    ...
    <div class="container">
        <div class="row gy-4">
            {{-- @dd($adv_to_check) --}}
            @if ($adv_to_check->count() > 1)
                @forelse ($adv_to_check as $adv)
                        ...
                        <div id="portfolio-details" class="portfolio-details">
                            <div class="card">
                                ...
                                <div class="portfolio-info">
                                    <h4 class="card-title fw-bold" style="color: #6230A3 ">{{ $adv->title }}
                                    </h4>
                                    <hr>
                                    <ul>
                                    ...
                                    <hr>
                                    <div><strong>Breve descrizione:</strong> {{ $adv->abstract }}</div>
                                    <br>
                                    ...
                                    <ul>
                                        <li><strong>Categorie</strong>: {{ $adv->category->name }} </li>
                                        <li><strong>Inserzionista</strong>: {{ $adv->user->name }}
                                            {{ $adv->user->surname }}</li>
                                        <li><strong>Pubblicato il</strong>:
                                            {{ $adv->created_at->format('d/m/Y') }}</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <form action="{{ route('revisor.accept_adv', ['adv' => $adv_to_check]) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="btn btn-outline-success mx-5">Accetta</button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <form action="{{ route('revisor.reject_adv', ['adv' => $adv_to_check]) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="btn btn-outline-danger mx-2 ">Rifiuta</button>
                                            </form>
                                        </div>
                                    </div>
